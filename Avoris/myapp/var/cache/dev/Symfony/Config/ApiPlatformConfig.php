    ...
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('docs_formats', $value)) {
            $this->_usedProperties['docsFormats'] = true;
            $this->docsFormats = array_map(function ($v) { return \is_array($v) ? new \Symfony\Config\ApiPlatform\DocsFormatsConfig($v) : $v; }, $value['docs_formats']);
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['docsFormats'])) {
            $output['docs_formats'] = array_map(function ($v) { return $v instanceof \Symfony\Config\ApiPlatform\DocsFormatsConfig ? $v->toArray() : $v; }, $this->docsFormats);
        }
