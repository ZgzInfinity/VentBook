...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5KqKx+uisO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c = new \Doctrine\Bundle\DoctrineBundle\Middleware\DebugMiddleware(($this->privates['doctrine.debug_data_holder'] ??= new \Doctrine\Bundle\DoctrineBundle\Middleware\BacktraceDebugDataHolder([0 => 'default'])), ($this->privates['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
        $c->setConnectionName('default');

        $a->setSchemaManagerFactory(new \Doctrine\DBAL\Schema\LegacySchemaManagerFactory());
        $a->setSchemaAssetsFilter(new \Doctrine\Bundle\DoctrineBundle\Dbal\SchemaAssetsFilterManager([0 => ($this->privates['doctrine_migrations.schema_filter_listener'] ??= new \Doctrine\Bundle\MigrationsBundle\EventListener\SchemaFilterListener('doctrine_migration_versions'))]));
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3Xky2PZV-H', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rMC3kpP6Lj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3GAB00nJn9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kpSloxyArZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSerializerService()
    {
        ...
        $e = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $b, $c)], [0 => $d]))));
        ...
        $l = ($this->privates['api_platform.resource_class_resolver'] ?? $this->getApiPlatform_ResourceClassResolverService());
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), 1 => $e, 2 => $e, 3 => new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $f), 4 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($g, [], $f), 5 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $f), 6 => $e, 7 => new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($o, $f), 8 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $i, $j, $l, $g, $f), 9 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $k, $g), 10 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($g, true, []), 11 => new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $f), 12 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, []), 13 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 14 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 15 => $o, 16 => $p, 17 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $f), 19 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 24 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 25 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($m, $l, $k, NULL), 'page', 'pagination', $h, $b, 1), $h, $l, ($this->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], []))), 26 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 27 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($q, $k, $m), 28 => $q], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $d, 2 => $r, 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), 5 => new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $r), 6 => new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), 7 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
